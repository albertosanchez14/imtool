...
exec > >(tee -a ftest-imtool-soa.txt) 2>&1

base_dir="$(dirname "$(realpath "${BASH_SOURCE[0]}")")"
imtool_executable="$base_dir/../cmake-build-debug/imtool-soa/imtool-soa"
...
deer_small_output="deer-small-output-soa.ppm"
lake_large_output="lake-large-output-soa.ppm"
lake_small_output="lake-small-output-soa.ppm"
sabatini_output="sabatini-output-soa.ppm"
